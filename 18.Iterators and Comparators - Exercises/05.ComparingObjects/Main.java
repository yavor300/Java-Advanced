...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        int equal = 0;
        Person personToComapereWith = people.get(n - 1);
        for (int i = 0; i < people.size(); i++) {
            if (i != n - 1) {
                int compare = people.get(i).compare(personToComapereWith, people.get(i));
                if (compare == 0) {
                    equal++;
                }
            }
        ...
        if (equal == 0) {
            ...
            System.out.println(String.format("%d %d %d", equal + 1, people.size() - equal - 1, people.size()));
        }
