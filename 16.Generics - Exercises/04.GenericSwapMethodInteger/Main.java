...
//    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            tokens[i] = Integer.parseInt(input);
        }
        String[] indexes = bfr.readLine().split("\\s+");

        Box<Integer> box = new Box<>(tokens);
        box.swap(Integer.parseInt(indexes[0]), Integer.parseInt(indexes[1]));
